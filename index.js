...
const cardInspiration =
  days < 0
    ...
    : "Хей, хей, хей<br/>оздравляем тебя  с днем рождения! <br/>Очень ценим,  что ты есть в нашей жизни! <br/>Ты очень класная, позитивная,  красивая, смешная<br/><br/>и вообще круто вау йоу пис";
